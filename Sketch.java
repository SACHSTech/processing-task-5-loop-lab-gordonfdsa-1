...
public class Sketch extends PApplet {
  ...
  public void draw_section3() {
    ...
    for (int intRow = 0; intRow < 30; intRow++) {
      for (int intColumn = 0; intColumn < 30; intColumn++) {
        intX = 600 + 3 + 10 * intRow; // Instead of zero, calculate the proper intX location using 'intRow'
        intY = 300 + 3 + 10 * intColumn; // Instead of zero, calculate the proper intY location using 'intColumn'
  ...
  public void draw_section4() {
    ...
    for (int intRow = 0; intRow < 30; intRow++) {
      for (int intColumn = 0; intColumn < 30; intColumn++) {
        intX = 900 + 3 + 10 * intRow; // Instead of zero, calculate the proper intX location using 'intRow'
        intY = 300 + 3 + 10 * intColumn; // Instead of zero, calculate the proper intY location using 'intColumn'
  ...
  public void draw_section5() {
    ...
    for (int intRow = 0; intRow < 30; intRow++) {
      for (int intColumn = 30 - intRow; intColumn < 30; intColumn++) {
        ...
        intX = 3 + 10 * intRow; // Instead of zero, calculate the proper intX location using 'intRow'
        intY = 3 + 10 * intColumn; // Instead of zero, calculate the proper intY location using 'intColumn'
